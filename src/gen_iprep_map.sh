...
fuDOWNLOAD "https://www.badips.com/get/list/any/2?age=90d" "bad reputation" "badips"
fuDOWNLOAD "http://osint.bambenekconsulting.com/feeds/c2-ipmasterlist.txt" "C2 server" "bambenek"
fuDOWNLOAD "https://lists.blocklist.de/lists/all.txt" "bad reputation" "blocklist"
...
fuDOWNLOAD "https://raw.githubusercontent.com/firehol/blocklist-ipsets/master/cruzit_web_attacks.ipset" "bad reputation" "firehol_cruzit"
...
fuDOWNLOAD "https://iplists.firehol.org/files/dshield_30d.netset" "bad reputation" "firehol_cleantalk"
fuDOWNLOAD "https://iplists.firehol.org/files/darklist_de.netset" "bad reputation" "firehol_darklist"
fuDOWNLOAD "https://iplists.firehol.org/files/dm_tor.ipset" "tor exit node" "firehol_dm_tor"
fuDOWNLOAD "http://danger.rulez.sk/projects/bruteforceblocker/blist.php" "bad reputation" "rulez"
fuDOWNLOAD "http://cinsscore.com/list/ci-badguys.txt" "bad reputation" "cinsscore"
...
fuDOWNLOAD "http://blocklist.greensnow.co/greensnow.txt" "bad reputation" "greensnow"
...
fuDOWNLOAD "https://report.cs.rutgers.edu/DROP/attackers" "bad reputation" "rutgers"
...
fuDOWNLOAD "https://threatintel.stdominics.sa.edu.au/droplist_high_confidence.txt" "bad reputation" "threatintel"
fuDOWNLOAD "https://sslbl.abuse.ch/blacklist/dyre_sslipblacklist_aggressive.csv" "C2 server" "dyre"
fuDOWNLOAD "http://charles.the-haleys.org/ssh_dico_attack_hdeny_format.php/hostsdeny.txt" "bad reputation" "charles"
...
fuDOWNLOAD "http://www.ipspamlist.com/public_feeds.csv" "bad reputation" "spamlist"
